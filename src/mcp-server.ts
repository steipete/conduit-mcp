...
const TOOLS = [
  {
    name: 'read',
    description: 'Read file contents, fetch web content, or extract data from various sources. Supports text files, web pages (HTML/Markdown conversion), images (OCR/metadata), and binary content.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
  ...
  {
    name: 'write',
    description: 'Write files, create directories, copy/move/delete files and directories. Includes touch operation for creating empty files or updating timestamps.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
  ...
  {
    name: 'list',
    description: 'List directory contents, get filesystem info, and retrieve system capabilities. Provides detailed file/directory information including metadata.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
  ...
  {
    name: 'find',
    description: 'Search for files and directories with powerful filtering options. Supports glob patterns, content search, metadata filters, and advanced search criteria.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
  ...
  {
    name: 'archive',
    description: 'Create and extract ZIP and TAR.GZ archives. Supports various compression options, path prefixes, and selective extraction.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
  ...
  {
    name: 'test',
    description: 'Test tool for debugging and validation. Echoes back provided parameters and can simulate various error conditions.',
    inputSchema: {
      type: 'object',
      properties: {
        operation: {
