                ...
                repeat with w in windows
                    try
                        ...
                        if name of w contains projectGroupSearchPatternForWindowName or name of w contains (projectIdentifierInTitle & projectGroupName) then
                            ...
                            set index of w to 1  -- Make window frontmost
                            activate
                            delay 0.2
                            tell application "System Events"
                            ...
                            delay 0.5
                            set newTabInGroup to selected tab of w
                            delay 0.3
...
on usageText()
    ...
    set outText to outText & "Enhancements: Better tab grouping, enhanced error reporting, verbose logging (optional)" & LF & LF
